...
const SearchTickets = ({ formValue, setFormValues }) => {
  ...
  return (
    <>
      ...
      <Modal
        show={showModalPassengers}
        size="sm"
        centered
        onHide={handleModalPassengers}
      >
        <Modal.Body>
        ...
        <div className="search-ticket-form">
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              >
                {formValue.origen ? formValue.origen : "---"}
                <span>Origen</span>
              </button>
            </div>
            <div className="col-md-6">
          ...
          <div className="row">
            <div className="col-md-6 d-flex align-items-center">
              <button
                className="select"
                onClick={() => handleModalPassengers()}
              >
                Pasajeros
                <span>
                  {formValue.passengers.Adult} Adultos,{" "}
                  {formValue.passengers.child} Niños,{" "}
                  {formValue.passengers.baby} bebes
                </span>
