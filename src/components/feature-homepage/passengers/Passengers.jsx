                ...
                typePassengers.map((passenger,index)=>(
                    <>
                        <div className="col-6 column" key={index}>
                            <span><b>{passenger.title}</b></span>
                            <p  className="m-0">{passenger.age}</p>
                        </div>
                        <div className="col-6">
                            <div className="hstack">
                                <button type="button" className="btn btn-left" onClick={()=>onCounterLess(passenger.type,formValue.passengers[passenger.type])}>
                                    <img src={Minus}  alt="less" />
                                </button>
                                <span className="number"><b>{formValue.passengers[passenger.type]}</b></span>
                                <button type="button" className="btn btn-right" onClick={()=>onCounterSum(passenger.type,formValue.passengers[passenger.type])}>
